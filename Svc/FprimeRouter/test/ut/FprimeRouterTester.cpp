...
void FprimeRouterTester ::testFileContextRoundTrip() {
    ...
    // Return the very buffer the router emitted on fileOut. The history entry holds it, so this hands that one
    // back rather than making a second reference to it.
